...
products = ['Laptop', 'Office Chair', 'Smartphone',
            'Desk', 'Headphones']
...
acquisition = [12, 25, 53, 56, 73, 55,
               56, 69, 48, 40, 67, 52]

customer_tenure = ['<3 Months', '3-6 Months',
